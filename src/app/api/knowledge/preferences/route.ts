...
// Knowledge Base text fields — persisted in the DB so they survive
// across devices/browsers, not just the current one.
const KEY_MAP = {
  audienceText: "knowledge_audience_text",
  styleText: "knowledge_style_text",
} as const;
